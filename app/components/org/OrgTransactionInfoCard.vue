 ...
 * Card displaying Transaction Terms (currency, tax, service charges).
 * Address and contact info is already shown in OrgHeroSection, so only transaction info is shown here.
 */
